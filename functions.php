...
function load_javascript(){
	...
	wp_register_script('appjs', get_template_directory_uri(). '/js/swiper-bundle.min.js','jquery', 0.1, true);
    wp_register_script('swiper', get_template_directory_uri(). '/js/app.js','', 3.0, true);
