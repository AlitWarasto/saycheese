  ...
  <div class="row">
    <?php while (have_posts()) : the_post();
      ...
      <div class="col-12 position-relative">
        <!-- Toast Info Harga -->
        <div id="info-harga" class="toast fade hide position-absolute col-12" data-autohide="false" style="width: 87vw;bottom: -21vh;background-color: white;z-index: 9;right: 50%;transform: translate(50%, 13%);box-shadow: 2px 5px 59px 25px rgb(0 0 0 / 39%);">
        ...
        <!-- Toast Rating Star -->
        <div id="rating-star" class="toast fade hide position-absolute" data-autohide="false" style="width: 70vw;bottom: -11vh;background-color: white;z-index: 9;right: 50%;transform: translate(50%, 0);box-shadow: 2px 5px 59px 25px rgb(0 0 0 / 39%);">
          <div class="toast-header">
