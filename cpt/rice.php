<?php
  /*### Rice ###*/
$rice = array(
    'name'                  => _x( 'Rice Panties Pizza', 'Post Type General Name', 'respanpiz theme' ),
		'singular_name'         => _x( 'Rice Panties Pizza', 'Post Type Singular Name', 'respanpiz theme' ),
		'menu_name'             => __( 'Rice Variant', 'respanpiz theme' ),
		'name_admin_bar'        => __( 'Rice Panties Pizza', 'respanpiz theme' ),
		...
		'all_items'             => __( 'All Rice', 'respanpiz theme' ),
		'add_new_item'          => __( 'Add New Rice', 'respanpiz theme' ),
		'add_new'               => __( 'New Rice', 'respanpiz theme' ),
		'new_item'              => __( 'New Rice', 'respanpiz theme' ),
		'edit_item'             => __( 'Edit Rice', 'respanpiz theme' ),
		'update_item'           => __( 'Update Menu', 'respanpiz theme' ),
		'view_item'             => __( 'View Rice', 'respanpiz theme' ),
...
register_post_type(
          ...
          'menu_icon' 	  => get_template_directory_uri() . '/img/admin/btn-rice.png',
          'menu_position' => 4,
