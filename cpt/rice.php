<?php
  /*### Rice ###*/
$rice = array(
  'name'                  => _x( 'Rice Panties Pizza', 'Post Type General Name', 'saycheese' ),
	'singular_name'         => _x( 'Rice Panties Pizza', 'Post Type Singular Name', 'saycheese' ),
	'menu_name'             => __( 'Rice Variant', 'saycheese' ),
	'name_admin_bar'        => __( 'Rice Panties Pizza', 'saycheese' ),
	'archives'              => __( 'Item Archives', 'saycheese' ),
	'attributes'            => __( 'Item Attributes', 'saycheese' ),
	'parent_item_colon'     => __( 'Parent Product:', 'saycheese' ),
	'all_items'             => __( 'All Rice', 'saycheese' ),
	'add_new_item'          => __( 'Add New Rice', 'saycheese' ),
	'add_new'               => __( 'New Rice', 'saycheese' ),
	'new_item'              => __( 'New Rice', 'saycheese' ),
	'edit_item'             => __( 'Edit Rice', 'saycheese' ),
	'update_item'           => __( 'Update Menu', 'saycheese' ),
	'view_item'             => __( 'View Rice', 'saycheese' ),
