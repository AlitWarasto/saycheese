...
<section id="section1">
	...
	<section id="section2" class="container-fluid">
	  <div class="row d-flex justify-content-center">
	  	...
	  	<h5 class="col-md-6 pr-5 pl-5 text-center">Selalu menggunakan keju yang berkualitas dan berserfikat HALAL dari MUI, serta memiliki 20 lebih varian rasa</h5>
	  </div>
	</section>
<?php get_footer(); ?>